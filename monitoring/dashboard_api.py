        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    today_schedules = 0
                    try:
                        from database.models import InterviewSchedule
                        ...
                        today_schedules = (
                            session_db.execute(
                                ...
                                .where(
                                    InterviewSchedule.scheduled_at >= start_of_today,
                                    InterviewSchedule.scheduled_at < end_of_today,
                    ...
                    todays_interviews = (
                        max(today_sessions, today_schedules)
                        if (today_sessions == 0 or today_schedules == 0)
                        else (today_sessions + today_schedules)
                    )
                finally:
                    session_db.close()
            except Exception as e:
            ...
            summary_data = {
                ...
                "today_interviews": todays_interviews,
            }
